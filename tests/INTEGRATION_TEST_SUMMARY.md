...
- **Fusion 360:** Available and running with CAM data
- **Test Document:** Contains 1 setup with 1 toolpath operation
- **Operation Type:** 2D Pocket (pocket2d)
- **Height Parameters:** All 5 parameters present and complete
- **Tool:** 12mm Flute End Mill with complete specifications
